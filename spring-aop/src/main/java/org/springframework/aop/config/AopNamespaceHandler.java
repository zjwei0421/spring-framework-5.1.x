 ...
 * {@code <aop:com.qinghe.config>} tag. A {@code com.qinghe.config} tag can include nested
...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	 ...
	 * '{@code com.qinghe.config}', '{@code spring-configured}', '{@code aspectj-autoproxy}'
	 * and '{@code scoped-proxy}' tags.
	 */
	@Override
	public void init() {
		// In 2.0 XSD as well as in 2.1 XSD.
		registerBeanDefinitionParser("com.qinghe.config", new ConfigBeanDefinitionParser());

...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	...
	/**
	 * Activate com.qinghe.config value editors which are only intended for configuration purposes,
	...
	private void createDefaultEditors() {
		...
		// Only register com.qinghe.config value editors if explicitly requested.

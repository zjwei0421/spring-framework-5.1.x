...
public class FreeMarkerConfigurationFactory {
	...
	/**
	 * Set the location of the FreeMarker com.qinghe.config file.
	 ...
	 * @throws IOException if the com.qinghe.config file wasn't found
	...
	public Configuration createConfiguration() throws IOException, TemplateException {
		...
		// Load com.qinghe.config file if specified.
	 ...
	 * @throws IOException if a com.qinghe.config file wasn't found
	 * @throws TemplateException on FreeMarker initialization failure
	 * @see #createConfiguration()
	 */

 ...
 * <pre class="code">
 * &lt;beans&gt;
 *    &lt;context:annotation-com.qinghe.config/&gt;
 *    &lt;bean class="com.acme.AppConfig"/&gt;
 * &lt;/beans&gt;
 * </pre>
 *
 * <p>In the example above, {@code <context:annotation-com.qinghe.config/>} is required in order to
 ...
 * <pre class="code">
 * &#064;Configuration
 * &#064;ImportResource("classpath:/com/acme/database-com.qinghe.config.xml")
 * public class AppConfig {
 *

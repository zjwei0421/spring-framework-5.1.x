 ...
 * registered automatically when using Java com.qinghe.config or manually via the
 * {@code <context:annotation-com.qinghe.config/>} or {@code <context:component-scan/>}
 * element when using XML com.qinghe.config.
 *

...
public class SQLErrorCodesFactory {
	...
	/**
	 * Map to hold error codes for all databases defined in the com.qinghe.config file.
	...
	protected SQLErrorCodesFactory() {
		...
		try {
			...
			logger.warn("Error loading SQL error codes from com.qinghe.config file", ex);

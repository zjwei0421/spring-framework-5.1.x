 ...
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/soap-ws-com.qinghe.config.xml")
 * public class SoapWebServiceTests extends AbstractWebTests {}
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/rest-ws-com.qinghe.config.xml")
 ...
 * three application contexts will be loaded: one for {@code "/app-com.qinghe.config.xml"},
 * one for {@code "/user-com.qinghe.config.xml"}, and one for <code>{"/user-com.qinghe.config.xml",
 * "/order-com.qinghe.config.xml"}</code>. As with the previous example, the application
 * context loaded from {@code "/app-com.qinghe.config.xml"} will be set as the parent context
 * for the contexts loaded from {@code "/user-com.qinghe.config.xml"} and <code>{"/user-com.qinghe.config.xml",
 * "/order-com.qinghe.config.xml"}</code>.
 *
 * <pre class="code">
 * &#064;RunWith(SpringRunner.class)
 * &#064;ContextHierarchy({
 *     &#064;ContextConfiguration(name = "parent", locations = "/app-com.qinghe.config.xml"),
 *     &#064;ContextConfiguration(name = "child",  locations = "/user-com.qinghe.config.xml")
 * })
 * public class BaseTests {}
 *
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/order-com.qinghe.config.xml")
 * )
 ...
 * only from {@code "/test-user-com.qinghe.config.xml"} and will have its parent set to the
 * context loaded from {@code "/app-com.qinghe.config.xml"}.
 *
 * <pre class="code">
 * &#064;RunWith(SpringRunner.class)
 * &#064;ContextHierarchy({
 ...
 *
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/test-user-com.qinghe.config.xml", inheritLocations = false)
 * )
 * public class ExtendedTests extends BaseTests {}</pre>
 *

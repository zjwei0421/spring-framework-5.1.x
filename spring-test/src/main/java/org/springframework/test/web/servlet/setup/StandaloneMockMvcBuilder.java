 ...
 * customization options are equivalent to using MVC Java com.qinghe.config except
...
public class StandaloneMockMvcBuilder extends AbstractMockMvcBuilder<StandaloneMockMvcBuilder> {
	 ...
	 * as Spring beans. However since the standalone setup does not load any Spring com.qinghe.config,

 ...
 *		 &lt;com.qinghe.config-property&gt;
 *			 &lt;com.qinghe.config-property-name&gt;ContextConfigLocation&lt;/com.qinghe.config-property-name&gt;
 *			 &lt;com.qinghe.config-property-type&gt;java.lang.String&lt;/com.qinghe.config-property-type&gt;
 *			 &lt;com.qinghe.config-property-value&gt;META-INF/applicationContext.xml&lt;/com.qinghe.config-property-value&gt;
 *		 &lt;/com.qinghe.config-property&gt;
 *	 &lt;/resourceadapter&gt;
 * &lt;/connector&gt;</pre>
 *
 * Note that "META-INF/applicationContext.xml" is the default context com.qinghe.config
 * location, so it doesn't have to specified unless you intend to specify
 * different/additional com.qinghe.config files. So in the default case, you may remove
 * the entire {@code com.qinghe.config-property} section above.
 *
...
public class SpringContextResourceAdapter implements ResourceAdapter {
	 ...
	 * multiple context com.qinghe.config paths in a single String value.
	 * @see #setContextConfigLocation
	 */
	 ...
	 * <p>This can be specified as "ContextConfigLocation" com.qinghe.config
	...
	protected ConfigurableApplicationContext createApplicationContext(BootstrapContext bootstrapContext) {
		...
		// Extract individual com.qinghe.config locations.
	 ...
	 * @param configLocations the parsed com.qinghe.config locations
	 * @see #setContextConfigLocation
	 */

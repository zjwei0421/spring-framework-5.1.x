...
public class HttpComponentsClientHttpRequestFactory implements ClientHttpRequestFactory, DisposableBean {
	 ...
	 * Can return {@code null} to indicate that no custom request com.qinghe.config should
	 ...
	 * @param clientConfig the com.qinghe.config held by the current
	 * @return the merged request com.qinghe.config
	 * @since 4.2
	 */

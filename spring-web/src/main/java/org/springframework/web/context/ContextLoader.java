...
public class ContextLoader {
	 ...
	 * com.qinghe.config location for the root context, falling back to the implementation's
	 * default otherwise.
	 ...
	 * ContextLoader after com.qinghe.config locations have been supplied to the context

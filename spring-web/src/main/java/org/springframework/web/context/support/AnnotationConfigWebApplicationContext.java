 ...
 * for registering classes one by one (specifying class names as com.qinghe.config location) as well
 * as for classpath scanning (specifying base packages as com.qinghe.config location).
 *
		...
		if (configLocations != null) {
			for (String configLocation : configLocations) {
				try {
					...
					if (logger.isTraceEnabled()) {
						logger.trace("Could not load class for com.qinghe.config location [" + configLocation +

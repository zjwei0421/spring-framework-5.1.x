 ...
 *
 * <p>The com.qinghe.config location defaults can be overridden via the "contextConfigLocation"
 ...
 *
 * <p>Note: In case of multiple com.qinghe.config locations, later bean definitions will
...
public class GroovyWebApplicationContext extends AbstractRefreshableWebApplicationContext implements GroovyObject {
	...
	/** Default com.qinghe.config location for the root context. */
	public static final String DEFAULT_CONFIG_LOCATION = "/WEB-INF/applicationContext.groovy";

	/** Default prefix for building a com.qinghe.config location for a namespace. */
	public static final String DEFAULT_CONFIG_LOCATION_PREFIX = "/WEB-INF/";

	/** Default suffix for building a com.qinghe.config location for a namespace. */

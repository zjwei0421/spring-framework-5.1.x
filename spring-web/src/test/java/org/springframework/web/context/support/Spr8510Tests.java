 ...
 * regard to com.qinghe.config location precedence, overriding and defaulting in programmatic
...
public class Spr8510Tests {
	...
	/**
	 * If context com.qinghe.config locations have been specified neither against the application

...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	/** Explicit context com.qinghe.config location. */
	@Nullable
	 ...
	 * to be used for building a default context com.qinghe.config location.
	 */
	...
	/**
	 * Set the context com.qinghe.config location explicitly, instead of relying on the default
	...
	/**
	 * Return the explicit context com.qinghe.config location, if any.
	 */
	@Nullable

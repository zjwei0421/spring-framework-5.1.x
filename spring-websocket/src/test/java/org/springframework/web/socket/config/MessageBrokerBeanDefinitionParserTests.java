 ...
 * Also see test configuration files websocket-com.qinghe.config-broker-*.xml.
 *
 * @author Brian Clozel
 * @author Artem Bilan
...
public class MessageBrokerBeanDefinitionParserTests {
	...
	public void simpleBroker() throws Exception {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-simple.xml");
	...
	public void stompBrokerRelay() {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-relay.xml");
	...
	public void customChannels() {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-customchannels.xml");
	...
	public void customChannelsWithDefaultExecutor() {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-customchannels-default-executor.xml");
	...
	public void customArgumentAndReturnValueTypes() {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-custom-argument-and-return-value-types.xml");
	...
	public void messageConverters() {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-converters.xml");
	...
	public void messageConvertersDefaultsOff() {
		loadBeanDefinitions("websocket-com.qinghe.config-broker-converters-defaults-off.xml");

...
{api-spring-framework}/beans/factory/com.qinghe.config/FieldRetrievingFactoryBean.html[`FieldRetrievingFactoryBean`]
...
{api-spring-framework}/beans/factory/com.qinghe.config/FieldRetrievingFactoryBean.html#setStaticField(java.lang.String)[`staticField`]
property:
...
----
	...
	<bean id="testBean.age" class="org.springframework.beans.factory.com.qinghe.config.PropertyPathFactoryBean"/>
----
====
...
----
	...
	<bean id="theAge"
			class="org.springframework.beans.factory.com.qinghe.config.PropertyPathFactoryBean">
...
----
	...
	<bean id="jdbcConfiguration" class="org.springframework.beans.factory.com.qinghe.config.PropertiesFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.qinghe.config.ListFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.qinghe.config.MapFactoryBean">
...
----
	...
	<bean id="emails" class="org.springframework.beans.factory.com.qinghe.config.SetFactoryBean">
...
==== Using `<annotation-com.qinghe.config/>`
...
* <<core.adoc#beans-annotation-com.qinghe.config, `@Autowired`/`@Inject`>> and `@Value`
...
This element is detailed in the section on <<core.adoc#beans-annotation-com.qinghe.config,
...
Spring distribution, you should first read the appendix entitled <<xsd-com.qinghe.config>>.
...
----
	...
	import org.springframework.beans.factory.com.qinghe.config.BeanDefinition;
...
----
	...
	import org.springframework.beans.factory.com.qinghe.config.BeanDefinitionHolder;
	import org.springframework.beans.factory.support.AbstractBeanDefinition;
	import org.springframework.beans.factory.support.BeanDefinitionBuilder;

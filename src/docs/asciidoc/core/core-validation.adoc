...
[subs="verbatim,quotes"]
----
	<bean class="org.springframework.beans.factory.com.qinghe.config.CustomEditorConfigurer">
...
[[core-convert-Spring-com.qinghe.config]]
...
<<web.adoc#mvc-com.qinghe.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
See <<web.adoc#mvc-com.qinghe.config-conversion, Conversion and Formatting>> in the Spring MVC chapter.
...
See <<web.adoc#mvc-com.qinghe.config-conversion, Conversion and Formatting>> for details.
...
See <<web.adoc#mvc-com.qinghe.config-validation, Validation>> in the Spring MVC chapter.

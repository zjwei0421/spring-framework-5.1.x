...
The `<aop:com.qinghe.config/>` definition ensures that the transactional advice defined by the
...
consider using the Spring `context:annotation-com.qinghe.config` XML element in your application
...
----
	<beans>
		...
		<!-- post-processors for all standard com.qinghe.config annotations -->
...
[[oxm-schema-based-com.qinghe.config]]

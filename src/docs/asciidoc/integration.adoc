...
<<web.adoc#mvc-com.qinghe.config-message-converters, Configuring Message Converters>>).
...
The `org.springframework.jms.com.qinghe.config` package provides the parser implementation for the
`jms` namespace as well as the java com.qinghe.config support to configure listener containers and
...
----
	...
	<bean id="jmsListenerContainerFactory"
			class="org.springframework.jms.com.qinghe.config.DefaultJmsListenerContainerFactory">
		<property name="connectionFactory" ref="connectionFactory"/>
...
case (through setting the 'proxy-target-class' flag on `<aop:com.qinghe.config/>`,
...
[[cci-com.qinghe.config]]
=== Configuring CCI

This section covers how to configure a Common Client Interface (CCI). It includes the
following topics:

* <<cci-com.qinghe.config-connector>>
* <<cci-com.qinghe.config-connectionfactory>>
* <<cci-com.qinghe.config-cci-connections>>
* <<cci-com.qinghe.config-single-connection>>
...
[[cache-annotations-com.qinghe.config]]
...
The `aop:com.qinghe.config` definition applies the cache advice to the appropriate points in the
...
----
	...
	<bean id="ehcache"
			class="org.springframework.cache.ehcache.EhCacheManagerFactoryBean" p:com.qinghe.config-location="ehcache.xml"/>
----
====
...
[[cache-specific-com.qinghe.config]]

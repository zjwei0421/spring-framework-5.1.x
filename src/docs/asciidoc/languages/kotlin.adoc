...
https://docs.spring.io/spring-boot/docs/current/reference/html/boot-features-external-com.qinghe.config.html#boot-features-external-com.qinghe.config-typesafe-configuration-properties[`@ConfigurationProperties`]

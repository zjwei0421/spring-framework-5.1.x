...
[[webtestclient-controller-com.qinghe.config]]
=== Bind to Controller
...
The preceding example loads the <<web-reactive.adoc#webflux-com.qinghe.config, WebFlux Java configuration>>
...
[[webtestclient-fn-com.qinghe.config]]
...
[[webtestclient-context-com.qinghe.config]]
...
[[webtestclient-server-com.qinghe.config]]
=== Bind to Server
...
[[webtestclient-client-com.qinghe.config]]
=== Client Builder

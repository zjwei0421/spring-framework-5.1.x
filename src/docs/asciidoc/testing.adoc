...
----
	@ContextConfiguration("/test-com.qinghe.config.xml") <1>
...
----
	@ContextHierarchy({
		@ContextConfiguration("/parent-com.qinghe.config.xml"),
		@ContextConfiguration("/child-com.qinghe.config.xml")
	})
...
----
	...
	@Sql(
		...
		com.qinghe.config = @SqlConfig(commentPrefix = "`", separator = "@@") <1>
	)
	public void userTest {
...
----
	@Test
	@SqlGroup({ <1>
		@Sql(scripts = "/test-schema.sql", com.qinghe.config = @SqlConfig(commentPrefix = "`")),
...
[subs="verbatim,quotes"]
----
	@SpringJUnitConfig(locations = "/test-com.qinghe.config.xml") <1>
...
[subs="verbatim,quotes"]
----
	@SpringJUnitWebConfig(locations = "/test-com.qinghe.config.xml") <1>
...
----
	...
	@ContextConfiguration({"/app-com.qinghe.config.xml", "/test-data-access-com.qinghe.config.xml"})
	@ActiveProfiles("dev")
	@Transactional
...
the `TestContextManager` with which the listener is registered. See <<testcontext-tel-com.qinghe.config>>.
...
[[testcontext-tel-com.qinghe.config]]
...
[[testcontext-tel-com.qinghe.config-registering-tels]]
...
[[testcontext-tel-com.qinghe.config-automatic-discovery]]
...
[[testcontext-tel-com.qinghe.config-ordering]]
...
through the <<testcontext-tel-com.qinghe.config-automatic-discovery, aforementioned>>
...
[[testcontext-tel-com.qinghe.config-merging]]
...
the aforementioned <<testcontext-tel-com.qinghe.config-automatic-discovery, automatic discovery
mechanism>>.
...
of `AnnotationAwareOrderComparator`, as described in <<testcontext-tel-com.qinghe.config-ordering>>.
...
* <<testcontext-ctx-management-mixed-com.qinghe.config>>
...
is treated as an absolute classpath location (for example, `/org/example/com.qinghe.config.xml`). A
...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from "/app-com.qinghe.config.xml" and
	// "/test-com.qinghe.config.xml" in the root of the classpath
	@ContextConfiguration(locations={"/app-com.qinghe.config.xml", "/test-com.qinghe.config.xml"}) <1>
	public class MyTest {
		// class body...
	}
----
...
----
	@RunWith(SpringRunner.class)
	@ContextConfiguration({"/app-com.qinghe.config.xml", "/test-com.qinghe.config.xml"}) <1>
	public class MyTest {
		// class body...
	}
----
...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from
	// "/app-com.qinghe.config.xml" and "/TestConfig.groovy"
	@ContextConfiguration({ "/app-com.qinghe.config.xml", "/TestConfig.groovy" })
	public class MyTest {
		// class body...
	}
----
...
`ExtendedTest` is loaded from `base-com.qinghe.config.xml` and `extended-com.qinghe.config.xml`, in that order.
Beans defined in `extended-com.qinghe.config.xml` can, therefore, override (that is, replace) those
defined in `base-com.qinghe.config.xml`. The following example shows how one class can extend
...
----
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from "/base-com.qinghe.config.xml"
	// in the root of the classpath
	@ContextConfiguration("/base-com.qinghe.config.xml") <1>
	public class BaseTest {
		// class body...
	}

	// ApplicationContext will be loaded from "/base-com.qinghe.config.xml" and
	// "/extended-com.qinghe.config.xml" in the root of the classpath
	@ContextConfiguration("/extended-com.qinghe.config.xml") <2>
	...
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<beans profile="dev">
			<jdbc:embedded-database id="dataSource">
				<jdbc:script
					location="classpath:com/bank/com.qinghe.config/sql/schema.sql"/>
				<jdbc:script
					location="classpath:com/bank/com.qinghe.config/sql/test-data.sql"/>
...
----
	...
	@RunWith(SpringRunner.class)
	// ApplicationContext will be loaded from "classpath:/app-com.qinghe.config.xml"
	@ContextConfiguration("/app-com.qinghe.config.xml")
	@ActiveProfiles("dev")
...
`app-com.qinghe.config.xml` configuration file in the root of the classpath. If you inspect
`app-com.qinghe.config.xml`, you can see that the `accountRepository` bean has a dependency on a
	...
	public class StandaloneDataConfig {
		...
		public DataSource dataSource() {
			return new EmbeddedDatabaseBuilder()
				...
				.addScript("classpath:com/bank/com.qinghe.config/sql/schema.sql")
				.addScript("classpath:com/bank/com.qinghe.config/sql/test-data.sql")
				.build();
		}
	}
----
...
----
	...
	// classpath resource
	@ContextConfiguration("/spring/test-servlet-com.qinghe.config.xml")
...
----
	...
	// file system resource
	@ContextConfiguration("file:src/main/webapp/WEB-INF/servlet-com.qinghe.config.xml")
...
For example, if `TestClassA` specifies `{"app-com.qinghe.config.xml", "test-com.qinghe.config.xml"}` for the
...
`{"app-com.qinghe.config.xml", "test-com.qinghe.config.xml"}` for its locations (either explicitly or
...
are loaded: one for `/app-com.qinghe.config.xml`, one for `/user-com.qinghe.config.xml`, and one for
`{"/user-com.qinghe.config.xml", "/order-com.qinghe.config.xml"}`. As with the previous example, the
application context loaded from `/app-com.qinghe.config.xml` is set as the parent context for the
contexts loaded from `/user-com.qinghe.config.xml` and `{"/user-com.qinghe.config.xml", "/order-com.qinghe.config.xml"}`.
...
application context for `ExtendedTests` is loaded only from `/test-user-com.qinghe.config.xml` and
has its parent set to the context loaded from `/app-com.qinghe.config.xml`. The following listing
...
----
	...
	@ContextHierarchy(
		@ContextConfiguration(
			name = "child",
			locations = "/test-user-com.qinghe.config.xml",
...
----
	...
	@ContextConfiguration("repository-com.qinghe.config.xml")
...
`@ContextConfiguration` annotation (that is, `repository-com.qinghe.config.xml`). The following
...
[[testcontext-tx-mgr-com.qinghe.config]]
...
----
	...
	@Sql(
		...
		com.qinghe.config = @SqlConfig(transactionMode = ISOLATED)
	)
	@Sql(
...
declared directly by using the `com.qinghe.config` attribute of the `@Sql` annotation, `@SqlConfig`

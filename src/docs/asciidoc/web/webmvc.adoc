...
(see <<mvc-container-com.qinghe.config>>):
...
[[mvc-servlet-com.qinghe.config]]
=== Web MVC Config
[.small]#<<web-reactive.adoc#webflux-framework-com.qinghe.config, Same as in Spring WebFlux>>#
...
In most cases, the <<mvc-com.qinghe.config>> is the best starting point. It declares the required
...
[[mvc-container-com.qinghe.config]]
=== Servlet Config
...
----
	public class MyWebAppInitializer extends AbstractDispatcherServletInitializer {
		...
		protected WebApplicationContext createServletApplicationContext() {
			...
			cxt.setConfigLocation("/WEB-INF/spring/dispatcher-com.qinghe.config.xml");
			return cxt;
		}
...
See <<mvc-com.qinghe.config-interceptors>> in the section on MVC configuration for examples of how to
...
The <<mvc-com.qinghe.config>> automatically declares built-in resolvers for default Spring MVC
...
configuration. The <<mvc-com.qinghe.config>> provides a dedicated configuration API for
<<mvc-com.qinghe.config-view-resolvers>> and for adding logic-less
<<mvc-com.qinghe.config-view-controller, View Controllers>> which are useful for HTML template
...
See <<mvc-com.qinghe.config-view-resolvers>> under <<mvc-com.qinghe.config>> for configuration details.
...
* In `web.xml`, add a `"<multipart-com.qinghe.config>"` section to the servlet declaration.
...
See <<mvc-com.qinghe.config-path-matching>> in the configuration section.
...
* `useSuffixPatternMatching(false)`, see <<mvc-com.qinghe.config-path-matching, PathMatchConfigurer>>
* `favorPathExtension(false)`, see <<mvc-com.qinghe.config-content-negotiation, ContentNegotiationConfigurer>>
...
`mediaTypes` property of <<mvc-com.qinghe.config-content-negotiation,ContentNegotiationConfigurer>>.
...
See <<mvc-com.qinghe.config-content-negotiation>>.
...
<<mvc-com.qinghe.config-path-matching>>. In the MVC XML namespace, you can set
...
You can use the <<mvc-com.qinghe.config-message-converters>> option of the <<mvc-com.qinghe.config>> to
...
<<mvc-com.qinghe.config-conversion,MVC com.qinghe.config>> to register `Converter` and `Formatter`
...
for optimal performance. See the section on configuring <<mvc-com.qinghe.config-static-resources>>.
...
[[mvc-com.qinghe.config]]
== MVC Config
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config, Same as in Spring WebFlux>>#
...
see <<mvc-com.qinghe.config-advanced-java>> and <<mvc-com.qinghe.config-advanced-xml>>.
...
and <<mvc-servlet-com.qinghe.config>>.



[[mvc-com.qinghe.config-enable]]
=== Enable MVC Configuration
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-enable, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-customize]]
=== MVC Config API
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-customize, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-conversion]]
=== Type Conversion
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-conversion, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-validation]]
=== Validation
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-validation, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-interceptors]]
=== Interceptors
...
[[mvc-com.qinghe.config-content-negotiation]]
=== Content Types
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-content-negotiation, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-message-converters]]
=== Message Converters
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-message-codecs, Same as in Spring WebFlux>>#

You can customize `HttpMessageConverter` in Java configuration by overriding
{api-spring-framework}/web/servlet/com.qinghe.config/annotation/WebMvcConfigurer.html#configureMessageConverters-java.util.List-[`configureMessageConverters()`]
(to replace the default converters created by Spring MVC) or by overriding
{api-spring-framework}/web/servlet/com.qinghe.config/annotation/WebMvcConfigurer.html#extendMessageConverters-java.util.List-[`extendMessageConverters()`]
...
[[mvc-com.qinghe.config-view-controller]]
=== View Controllers
...
[[mvc-com.qinghe.config-view-resolvers]]
=== View Resolvers
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-view-resolvers, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-static-resources]]
=== Static Resources
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-static-resources, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-path-matching]]
=== Path Matching
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-path-matching, Same as in Spring WebFlux>>#

You can customize options related to path matching and treatment of the URL.
For details on the individual options, see the
{api-spring-framework}/web/servlet/com.qinghe.config/annotation/PathMatchConfigurer.html[`PathMatchConfigurer`] javadoc.
...
[[mvc-com.qinghe.config-advanced-java]]
=== Advanced Java Config
[.small]#<<web-reactive.adoc#webflux-com.qinghe.config-advanced-java, Same as in Spring WebFlux>>#
...
[[mvc-com.qinghe.config-advanced-xml]]
=== Advanced XML Config

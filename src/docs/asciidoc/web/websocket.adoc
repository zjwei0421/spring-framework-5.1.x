...
[subs="verbatim,quotes"]
----
	import org.springframework.web.socket.com.qinghe.config.annotation.EnableWebSocket;
	import org.springframework.web.socket.com.qinghe.config.annotation.WebSocketConfigurer;
	import org.springframework.web.socket.com.qinghe.config.annotation.WebSocketHandlerRegistry;
...
[.small]#<<web-reactive.adoc#webflux-websocket-server-com.qinghe.config, Same as in Spring WebFlux>>#
...
WebSocket Java com.qinghe.config, as the following example shows:
...
that into Spring's `DefaultHandshakeHandler` through your WebSocket Java com.qinghe.config.
...
[subs="verbatim,quotes"]
----
	import org.springframework.web.socket.com.qinghe.config.annotation.EnableWebSocketMessageBroker;
	import org.springframework.web.socket.com.qinghe.config.annotation.StompEndpointRegistry;
	...
	public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
		...
		@Override
		public void configureMessageBroker(MessageBrokerRegistry com.qinghe.config) {
			com.qinghe.config.setApplicationDestinationPrefixes("/app"); // <2>
			com.qinghe.config.enableSimpleBroker("/topic", "/queue"); // <3>
		}
	}
----
...
[[websocket-stomp-server-com.qinghe.config]]
=== WebSocket Server
...
you need to ensure that the authentication `ChannelInterceptor` com.qinghe.config is ordered
